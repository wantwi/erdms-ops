...
import { useSelector } from "react-redux";
  ...
  const ServiceSelectionTable = ({showTable, setShowTable, setSelecteService,data,title}) => {
    const myGrid =  useRef()
    ...
    const handleClickEvent = () =>{
      ...
      // console.log({myGrid:myGrid.current.getSelectedRecords()});
      setSelecteService((prev) =>([...prev,...myGrid.current.getSelectedRecords()]))
      setShowTable(false)
    }
