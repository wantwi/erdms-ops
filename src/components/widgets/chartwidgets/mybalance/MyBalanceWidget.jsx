    ...
    <MyBalanceWidgetWrapper className="fill-height">
      <div className="card roe-shadow-2 fill-height">
        <div className="card-body">
          <h4 className="fs-18 header">My Balance</h4>
          <div className="d-lg-flex justify-content-between align-items-center">
            <h1 className="text-dark mb-0 fs-24 mt-3">$5800</h1>
            <p className="nevy--text mb-0 font-weight-medium fs-12">
              +40.42% ($211)
            </p>
          </div>
          <p className="mb-4 mt-1 pb-1 text-muted fs-13">
          ...
          <div className="border p-3 mt-2">
            <div className="row">
              <div className="col-sm-6 mb-4 mb-lg-0">
                <div className="d-lg-flex justify-content-between align-items-center">
                  <div className="fs-14 text-small text-dark">Available :</div>
                </div>
                <div>
                  <Progress
                    percent={48}
              ...
              <div className="col-sm-6">
                <div className="d-lg-flex justify-content-between align-items-center">
                  <div className="fs-14 text-small text-dark">Pending :</div>
                </div>
                <div>
                  <Progress
                    percent={75}
