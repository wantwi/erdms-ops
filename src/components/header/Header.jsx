...
const Header = props => {
  ...
  let notficatonConnection = useRef(
  ...
  const { notificationMassages } = useSelector(
      ...
      <div className="headerBack">
        <div className="flex-x align-center">
          ...
          >
            ...
            <span className="app-name fs-16 bold-text">{"OPERATION"}</span>
          </div>
          ...
          <div className="pl-10">
            <div id="profile">
              <span style={{ fontWeight: 500 }}>{auth?.given_name}</span>{" "}
              <img
